...
while count <= total:  
    ...
    #Physical
    agilityRand = random.randint(4,10)
    flexibilityRand = random.randint(4,10)
    balanceRand = random.randint(4,10)
    staminaRand = random.randint(4,10)
    strengthRand = random.randint(4,10)
    #PlayerCondition
    playerCondition = 50
    #Mental
    awarenessRand = random.randint(4,10)
    determinationRand = random.randint(4,10)
    positivityRand = random.randint(4,10)
    demeanorRand = random.randint(4,10)
    fortitudeRand = random.randint(4,10)
    #Equipment
    fitRand = random.randint(4,10)
    qualityRand = random.randint(8,20)
    equipAccuracyRand = random.randint(8,20)
    #Mechanics
    ballStrikingRand = random.randint(4,10)
    accuracyRand = random.randint(4,10)
    swingRand = random.randint(4,10)
    tempoRand = random.randint(4,10)
    shotShapingRand = random.randint(4,10)
