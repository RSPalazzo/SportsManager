...
while count <= total:  
    ...
    #Physical
    agilityRand = random.randint(1,10)
    flexibilityRand = random.randint(1,10)
    balanceRand = random.randint(1,10)
    staminaRand = random.randint(1,10)
    strengthRand = random.randint(1,10)
    #PlayerCondition
    playerCondition = 50
    #Mental
    awarenessRand = random.randint(1,10)
    determinationRand = random.randint(1,10)
    positivityRand = random.randint(1,10)
    demeanorRand = random.randint(1,10)
    fortitudeRand = random.randint(1,10)
    #Equipment
    fitRand = random.randint(1,10)
    qualityRand = random.randint(1,20)
    equipAccuracyRand = random.randint(1,20)
    #Mechanics
    ballStrikingRand = random.randint(1,10)
    accuracyRand = random.randint(1,10)
    swingRand = random.randint(1,10)
    tempoRand = random.randint(1,10)
    shotShapingRand = random.randint(1,10)
