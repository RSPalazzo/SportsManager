    ...
    class ShotResult
     {
        ...
        public int getShotResultsYards (Player player, int shotTraj, int grass, int rain, int altitude, int temp, int shotGrade, 
                                            int baseDistance, string shotType, int distanceToHole)
        {
            ...
            {
                int totalStats = player.attributes.physical.strength + player.attributes.physical.flexibility + player.attributes.physical.balance 
                                    + player.attributes.physical.agility + player.attributes.mechanics.tempo + player.attributes.mechanics.swing 
                                    + player.attributes.mechanics.ballStriking + player.attributes.equipment.fit + player.attributes.equipment.quality 
                                    + player.attributes.mental.demeanor + player.attributes.playerCondition;
                                    // + grass + rain + altitude + temp
